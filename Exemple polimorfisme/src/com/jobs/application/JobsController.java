...
public class JobsController {
	...
	public void createVolunteer(String string, String string2, String string3, String description) throws Exception {
		// TODO Auto-generated method stub
		
		Volunteer volunteer = new Volunteer(string, string2, string3, description);
